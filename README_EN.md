...
| Qwen Image 2.0 / 2.0 Pro (Alibaba) | 千问 | Image Editing | 2 |
...
The project includes 170 example workflow JSON files in the `examples/` directory, covering every model node. Download and import directly into ComfyUI.
...
├── models_registry.json     # Model registry (170 model definitions)
├── config/
...
└── examples/                # 170 example workflows
```
